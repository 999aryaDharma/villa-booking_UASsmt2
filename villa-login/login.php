    ...
    <div class="bg-white w-3/5 rounded-xl p-7 shadow-inner">
        ...
        <div id="sign_in" class="flex">
            ...
            <div class="w-2/5">
                <div>
                    <div class="mb-3">
                        <h1 class="text-2xl custom-color2">Sign In</h1>
                    </div>
                    
                    <form action="auth.php" method="POST">
                        <div class="mb-4">
                            <label for="username">Username</label>
                            <input type="text" name="username" id="username" autocomplete="username" required placeholder="Username" class="w-full px-3 py-2 border-2 rounded focus:border-1 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:z-10 sm:text-sm"> 
                        </div>
                        <div class="mb-4">
                            <label for="password">Password</label>
                            <input type="password" name="password" id="password" autocomplete="current-password" required placeholder="Password" class="w-full px-3 py-2 border-2 rounded focus:border-1 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:z-10 sm:text-sm">
                        </div>
                        ...
                        <div class="text-center text-sm">
                            <p class="text-slate-500">Don't have an account? <a href="#" class="custom-color1 hover:text-emerald-400">Sign Up</a></p>
                        </div>
                    </form>
                </div>
            </div>
