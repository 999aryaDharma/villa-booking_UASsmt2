    ...
    <div class="border-2 border-inherit shadow-xl w-full p-5">
        ...
        <div>
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <input name="" type="text" placeholder="Number Of Persons" class="w-full px-3 py-2 mb-4 border-2 rounded focus:border-1 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:z-10 sm:text-sm">
                </div>
                <div>
                    <input name="" type="text" placeholder="Size" class="w-full px-3 py-2 mb-4 border-2 rounded focus:border-1 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:z-10 sm:text-sm">
                </div>
                <div>
                    <input name="" type="text" placeholder="View" class="w-full px-3 py-2 mb-4 border-2 rounded focus:border-1 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:z-10 sm:text-sm">
                </div>
                <div>
                ...
                <div>
                    <input name="" type="text" placeholder="Status Value" class="w-full px-3 py-2 mb-4 border-2 rounded focus:border-1 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:z-10 sm:text-sm">
                </div>
                <div>
