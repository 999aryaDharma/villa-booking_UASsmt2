    ...
    <div class="border-2 border-inherit shadow-xl w-full p-5">
        ...
        <div>
            <form action="" method="post">
                ...
                <div>
                    <input type="text" placeholder="Status" class="w-full px-3 py-2 mb-4 border-2 rounded focus:border-1 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:z-10 sm:text-sm">
                </div>
            </form>
        </div>
    </div>
