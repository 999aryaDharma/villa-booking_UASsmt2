    ...
    <table class="border-collapse border-2 border-inherit shadow-xl w-full">
        <thead>
            ...
            <tr>
                ...
                <th class="border-2 border-inherit px-3 py-1 text-left">Deskripsi Fasilitas</th>
        ...
        <?php foreach ($data as $v) : ?>
            <tbody>
                <tr>
                    ...
                    <td class="border-2 border-inherit p-3"><?= $v['deskripsi']; ?></td>
                    <td class="border-2 border-inherit p-3 text-center w-28"><a href="<?= "delete-fasilitas.php?id={$v['id_fasilitas']}" ?>" onclick="return confirm('Are you sure want delete this facility?');" class="inline-block btn bg-red-600 hover:bg-red-800 px-6 py-2 rounded-md text-center pointer-events-auto text-white">Delete</a></td>
                </tr>
                <?php $i++ ?>
            <?php endforeach; ?>
            </tbody>
