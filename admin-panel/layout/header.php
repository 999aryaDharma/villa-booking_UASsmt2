    ...
    <aside>
        <div class="fixed pt-20 bg-slate-400 h-full w-48 pl-7 z-50">
            <ul>
                ...
                <li class="hover:text-white "><a class="flex my-5" href="../fasilitas-crud/show-fasilitas.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2 icon icon-tabler icons-tabler-outline icon-tabler-wifi">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M12 18l.01 0" />
                        ...
                        <li class="nav-item dropdown float-left overflow-hidden">
                            <a class="nav-link  dropdown-toggle flex" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu hidden absolute bg-white p-2.5 shadow-xl border w-35" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item float-none text-black flex text-sm" href="../../auth/logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-logout">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
