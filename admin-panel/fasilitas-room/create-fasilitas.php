        ...
        <div>
            <form action="" method="post">
                ...
                <div>
                    ...
                    <input type="text" id="deskripsi_fasilitas" name="deskripsi-fasilitas" placeholder="Room Name" class="w-full px-3 py-2 mb-3 border-2 rounded focus:border-1 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:z-10 sm:text-sm">
                </div>
