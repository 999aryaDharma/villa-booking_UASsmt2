<!-- FOOTER -->
		...
		<script src="js/main.js"></script>
			...
			<div class="footer bg-green-800 text-white py-4 px-20">
    <div class="max-w-5xl grid grid-cols-1 md:grid-cols-4 gap-x-36">
        <div>
            <h3 class="font-bold mb-2 text-md">Pemuda Inguh Villa</h3>
            <h3 class="mt-2 text-sm">Welcome to Pemuda Inguh Villas</h3>
        </div>
        <div class="text-md">
            <h3 class="font-bold mb-2">Services</h3>
            <ul>
                <li class="mt-2 text-sm">Map Direction</li>
                <li class="mt-2 text-sm">Accommodation Services</li>
                <li class="mt-2 text-sm">Great Experiences</li>
                <li class="mt-2 text-sm">Perfect Central Location</li>
            </ul>
        </div>
        <div>
            <h3 class="font-bold mb-2 text-md">Follow Us</h3>
            <div class="flex space-x-2 gap-x-1">
        ...
        <div class="text-md">
            <h3 class="font-bold mb-2">Visit Us</h3>
            <a href="https://maps.app.goo.gl/8YTKxAp4qGzaTHj59" class="custom-underline text-sm">
